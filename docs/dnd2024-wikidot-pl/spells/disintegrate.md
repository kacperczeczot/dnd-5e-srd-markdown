...
**Komponenty:** V, S, M (magnetyt i pył)

**Czas trwania:** Natychmiastowy

Wystrzeliwujesz zielony promień w cel, który widzisz w zasięgu. Może to być istota, niemagiczny obiekt albo wytwór magicznej siły, na przykład ściana z zaklęcia [Ściana energii](../spells/wall-of-force.md).

Istota będąca celem wykonuje rzut obronny na Zręczność. Przy nieudanym rzucie otrzymuje 10k6 + 40 obrażeń od mocy. Jeśli te obrażenia sprowadzą ją do 0 PW, zostaje zdezintegrowana wraz ze wszystkim niemagicznym, co nosi i trzyma — w szary pył. Cel można wskrzesić tylko zaklęciem [Prawdziwe zmartwychwstanie](../spells/true-resurrection.md) albo [Życzenie](../spells/wish.md).
