...
**Komponenty:** V, S, M (pozłacana chochla o wartości 500+ sz)
...
Ciecz w kotle powiela właściwości pospolitej albo niepospolitej `mikstury` według twojego wyboru (np. [Mikstura leczenia](../magic-items/potion-of-healing.md)). Akcją dodatkową ty albo sojusznik możecie sięgnąć do kotła i wyciągnąć jedną miksturę tego rodzaju. Mikstura jest w fiolce, która znika po wypiciu. Kocioł może wyprodukować tyle mikstur, ile wynosi twój modyfikator rzucania czarami (minimum 1). Gdy ostatnia mikstura zostanie wyciągnięta, kocioł znika i zaklęcie się kończy.
