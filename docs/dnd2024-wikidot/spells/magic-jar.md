...
You can attempt to possess any Humanoid within 100 feet of you that you can see (creatures warded by a [Protection from Evil and Good](http://dnd2024.wikidot.com/spell:protection-from-evil-and-good) or [Magic Circle](http://dnd2024.wikidot.com/spell:magic-circle) spell can’t be possessed). The target makes a Charisma saving throw. On a failed save, your soul enters the target’s body, and the target’s soul becomes trapped in the container. On a successful save, the target resists your efforts to possess it, and you can’t attempt to possess it again for 24 hours.
