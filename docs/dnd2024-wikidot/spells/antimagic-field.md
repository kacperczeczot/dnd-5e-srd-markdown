...
[Dispel Magic](http://dnd2024.wikidot.com/spell:dispel-magic) has no effect on the aura, and the auras created by different Antimagic Field spells don’t nullify each other.
