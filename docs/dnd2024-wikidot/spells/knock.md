...
If the target is held shut by [Arcane Lock](http://dnd2024.wikidot.com/spell:arcane-lock), that spell is suppressed for 10 minutes, during which time the target can be opened and closed.
