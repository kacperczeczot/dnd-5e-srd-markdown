...
A [Remove Curse](http://dnd2024.wikidot.com/spell:remove-curse) or [Greater Restoration](http://dnd2024.wikidot.com/spell:greater-restoration) spell cast on the target restores the creature’s true memory.
