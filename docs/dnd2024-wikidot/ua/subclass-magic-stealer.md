...
Whenever you finish a Long Rest, you can cast the [Nondetection](http://dnd2024.wikidot.com/spell:nondetection) spell, using Intelligence as your spellcasting ability. When you do so, you can target only yourself, and the duration increases to 24 hours.
