...
# Transmuter (UA6 - 26.06.25)

**Source URL:** http://dnd2024.wikidot.com/ua:subclass-wizard-transmuter
...
You always have [Enhance Ability](http://dnd2024.wikidot.com/spell:enhance-ability) prepared and can cast it once without a spell slot. You regain the ability to cast it in this way when you finish a Long Rest.

Targets of your [Enhance Ability](http://dnd2024.wikidot.com/spell:enhance-ability) also have Advantage on saving throws using the chosen ability.

### Level 6: Split Transmutation

When you cast a Transmutation spell, such as [Fly](http://dnd2024.wikidot.com/spell:fly), that can be cast with a higher-level spell slot to target an additional creature, increase the spell’s effective level by 1.
...
**Restore Life.** You cast [Raise Dead](http://dnd2024.wikidot.com/spell:raise-dead) without a spell slot, using the stone in place of the normally required Material components.
