[Strona główna](../../../README.md) > [ua](README.md) > [feat-flesh-morpher](feat-flesh-morpher.md)

---

# Flesh Morpher (UA)

**Source URL:** http://dnd2024.wikidot.com/ua:feat-flesh-morpher
...
**Psionic Talent.** You always have the [Longstrider](http://dnd2024.wikidot.com/spell:longstrider) spell prepared. You can cast it once without a spell slot, and you regain the ability to cast it in that way when you finish a Long Rest. You can also cast it using any spell slots you have of the appropriate level. When you cast the spell, it requires no Verbal components, and Intelligence, Wisdom, or Charisma is your spellcasting ability for this spell (choose when you select this feat).

When you reach character level 3, you also always have the [Alter Self](http://dnd2024.wikidot.com/spell:alter-self) spell prepared and can cast it the same way.
