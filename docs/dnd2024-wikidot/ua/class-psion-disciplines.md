...
**Source URL:** http://dnd2024.wikidot.com/ua:class-psion-disciplines
...
When a creature provokes an Opportunity Attack from you by leaving your reach, you can take a Reaction to roll one Psionic Energy Die and force the creature to make an Intelligence saving throw. On a failed save, the target’s Speed is reduced by 10 feet and it subtracts the number rolled from the next damage roll it makes before the end of its next turn.

The die is expended only if the target fails the saving throw.
