...
# Arcane Archer (UA6 - 26.06.25)

**Source URL:** http://dnd2024.wikidot.com/ua:subclass-fighter-arcane-archer
...
You learn how to direct an errant shot toward a new target. If you make an attack roll with a weapon with the Ammunition property and miss, as a Bonus Action immediately after the attack, you can make an extra attack with the same weapon against a different target that you can see, that is within the weapon’s long range, and that isn’t behind Total Cover. This extra attack doesn’t require ammunition.
