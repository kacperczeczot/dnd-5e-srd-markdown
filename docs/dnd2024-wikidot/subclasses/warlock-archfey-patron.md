...
Your patron grants you the ability to move between the boundaries of the planes. You can cast [Misty Step](http://dnd2024.wikidot.com/spell:misty-step) without expending a spell slot a number of times equal to your Charisma modifier (minimum of once), and you regain all expended uses when you finish a Long Rest.
...
You can cast [Misty Step](http://dnd2024.wikidot.com/spell:misty-step) as a Reaction in response to taking damage.
...
Your patron grants you the ability to weave your magic with teleportation. Immediately after you cast an Enchantment or Illusion spell using an action and a spell slot, you can cast [Misty Step](http://dnd2024.wikidot.com/spell:misty-step) as part of the same action and without expending a spell slot.
