...
In addition, the first time each turn it hits a creature under the effect of your [Hunter's Mark](http://dnd2024.wikidot.com/spell:hunter-s-mark) spell, the beast deals extra Force damage equal to the bonus damage of that spell.
