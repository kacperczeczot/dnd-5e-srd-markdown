...
The Maintain order is unusual; it is issued to the whole Bastion rather than to one or more special facilities. If a character isn’t in their Bastion on a given Bastion turn, the Bastion acts as though it were issued the Maintain order on that turn unless the owner can communicate with the Bastion hirelings using the [Sending spell](http://dnd2024.wikidot.com/spell:sending) or similar magic.
...
| 9 | [Theatre](#Theatre) | None | Empower |
...
**Research: Helpful Lore.** When you issue the Research order to this facility, you commission the facility’s hireling to search the Archive for helpful lore. The work takes 7 days. The hireling gains knowledge as if they had cast the [Legend Lore](http://dnd2024.wikidot.com/spell:legend-lore) spell, then shares this knowledge with you the next time you speak with them.
...
**Bigby’s Burden.** Drinking a pint of this beverage grants you the “enlarge” effect of an [Enlarge/Reduce](http://dnd2024.wikidot.com/spell:enlarge-reduce) spell that has a duration of 24 hours (no saving throw allowed).

**Kiss of the Spider Queen.** Drinking a pint of this beverage grants you the effect of a [Spider Climb](http://dnd2024.wikidot.com/spell:spider-climb) spell that has a duration of 24 hours.
...
**Reliquary Charm.** After spending a Long Rest in your Bastion, you gain a magical Charm (see “Supernatural Gifts”) that lasts for 7 days or until you use it. The Charm allows you to cast [Greater Restoration](http://dnd2024.wikidot.com/spell:greater-restoration) once without expending a spell slot or using Material components. You can’t gain this Charm again while you still have it.
...
**Sanctum Charm.** After spending a Long Rest in your Bastion, you gain a magical Charm (see “Supernatural Gifts” in chapter 3) that lasts for 7 days or until you use it. The Charm allows you to cast [Heal](http://dnd2024.wikidot.com/spell:heal) once without expending a spell slot. You can’t gain this Charm again while you still have it.
...
Inscribed on the floor of this room is a permanent teleportation circle created by the [Teleportation Circle](http://dnd2024.wikidot.com/spell:teleportation-circle) spell.
...
| 9 | [Navigator's Helm](#Navigator-s-helm) | None | Empower |
| 9 | [Orien Helm](#Orien-Helm) | Renown 15+ with House Orien | Empower |
| 13 | [Artificer's Forge](#Artificer-s-Forge) | Ability to use Artisan’s Tools as a Spellcasting Focus | Craft |
| 13 | [Inquisitive's Agency](#Inquisitive-s-Agency) | None | Research |
...
- **Lamannia, the Twilight Forest.** When you use a spell slot to cast a spell that conjures or summons a Beast, an Elemental, or a Fey (including [Conjure Animals](http://dnd2024.wikidot.com/spell:conjure-animals), [Conjure Elemental](http://dnd2024.wikidot.com/spell:conjure-elemental), [Conjure Fey](http://dnd2024.wikidot.com/spell:conjure-fey), [Conjure Minor Elementals](http://dnd2024.wikidot.com/spell:conjure-minor-elementals), [Conjure Woodland Beings](http://dnd2024.wikidot.com/spell:conjure-woodland-beings), [Find Steed](http://dnd2024.wikidot.com/spell:find-steed), [Summon Beast](http://dnd2024.wikidot.com/spell:summon-beast), [Summon Elemental](http://dnd2024.wikidot.com/spell:summon-elemental), or [Summon Fey](http://dnd2024.wikidot.com/spell:summon-fey)), you can expend the Charm (no action required) to treat the spell as if it were cast using a spell slot 1 level above the slot expended.

- **Mabar, the Endless Night.** When you use a spell slot to cast a spell that animates or summons an Undead (including [Animate Dead](http://dnd2024.wikidot.com/spell:animate-dead), [Create Undead](http://dnd2024.wikidot.com/spell:create-undead), or [Summon Undead](http://dnd2024.wikidot.com/spell:summon-undead)), you can expend the Charm (no action required) to treat the spell as if it were cast using a spell slot 1 level above the slot expended.
...
- **Charm of Argonnessen.** While you have this Charm, you know Draconic. You can expend the Charm to cast [Dragon’s Breath](http://dnd2024.wikidot.com/spell:dragon-s-breath) (level 4 version), targeting yourself only.

- **Charm of Ashtakala.** While you have this Charm, you know Abyssal and Infernal. You can expend the Charm to cast [Ray of Sickness](http://dnd2024.wikidot.com/spell:ray-of-sickness) (level 4 version).

- **Charm of Dhakaan.** While you have this Charm, you know the Goblin language. You can expend the Charm to cast [Staggering Smite](http://dnd2024.wikidot.com/spell:staggering-smite).
...
| 5 | [Séance Parlor](#Seance-Parlor) | None | Research |
...
**Craft: Enhanced Potion of Healing.** You commission this facility’s hirelings to increase the potency of up to two [Potions of Healing](http://dnd2024.wikidot.com/magic-item:potion-of-healing). You must provide the potions to be enhanced, and the process takes 14 days to complete. A Potion of Healing becomes a Potion of Healing (greater). When you reach level 13 you can provide up to two Potions of Healing (greater), each of which becomes a Potion of Healing (superior).
...
**Charm of Electromancy.** After spending a Long Rest in your Lightning Generator, you take 8d6 Lightning damage and you gain a magical Charm that lasts for 7 days (see the Dungeon Master’s Guide for rules on Charms). The Charm has 3 charges. You can expend 1 charge from the Charm to cast the [Telekinesis](http://dnd2024.wikidot.com/spell:telekinesis) spell. Once all its charges are expended, the Charm vanishes from you.

**Revivification.** When you cast the spell [Raise Dead](http://dnd2024.wikidot.com/spell:raise-dead) and [Resurrection](http://dnd2024.wikidot.com/spell:resurrection) while in this facility, the cost of that spell’s Material components are reduced by 1,000 GP (minimum of 0).
...
**Charm of Exorcism.** You can use the Charm as a Magic action to cast [Dispel Evil and Good](http://dnd2024.wikidot.com/spell:dispel-evil-and-good) or [Remove Curse](http://dnd2024.wikidot.com/spell:remove-curse) without requiring Material components.

**Charm of Malediction.** You can use the Charm as a Magic action to cast [Hex](http://dnd2024.wikidot.com/spell:hex) (level 3 version) or [Bestow Curse](http://dnd2024.wikidot.com/spell:bestow-curse) without requiring Material components.
...
| 80-86 | [Spacial Warp](#Spacial-Warp) |
