...
**Source URL:** http://dnd2024.wikidot.com/circle-magic
...
If a Reaction would trigger when a creature casts a spell - such as the Reaction taken to cast [Counterspell](http://dnd2024.wikidot.com/spell:counterspell) - it also triggers when you take this action to initiate a Circle spell.
...
When you cast a spell that requires at least one Material component with a specified cost that is consumed by the spell, you can reduce the minimum cost of one such Material component by 50 GP per each secondary caster contributing to the spell. For example, casting [Revivify](http://dnd2024.wikidot.com/spell:revivify) as a Circle spell with two secondary casters would reduce the Material component’s minimum cost to 200 GP.
