...
A ship larger than a Keelboat or Rowboat needs a crew of skilled hirelings (see “Services” in the Player's Handbook) to function. The minimum number of skilled hirelings needed to crew a ship depends on the type of ship, as shown in the table.
...
| Warship | 2½ | 60 | 60 | 200 | 15 | 500 | 20 | 25,000 GP |

# Eberron: Forge of the Artificer Airships

| Ship | Speed | Crew | Passengers | Cargo (Tons) | AC | HP | Damage Threshold | Cost |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Lyrandar Air Cruiser | 10 mph (Fly Speed 100 ft. [hover]) | 10 | 40 | 2 | 16 | 600 | 20 | 50,000 GP |
| Lyrandar Skyskiff | 7 mph (Fly Speed 70 ft. [hover]) | 2 | 2 | 1/2 | 18 | 150 | 5 | 20,000 GP |
| Strider Airship | 8 mph (Fly Speed 80 ft. [hover]) | 6 | 20 | 1 | 16 | 350 | 10 | 40,000 GP |
