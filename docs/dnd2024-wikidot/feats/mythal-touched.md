...
| 8-10 | Gravity is reversed in a 15-foot-radius, 60-foot-tall Cylinder centered on you for 1 minute, per the [Reverse Gravity](http://dnd2024.wikidot.com/spell:reverse-gravity) spell. |
