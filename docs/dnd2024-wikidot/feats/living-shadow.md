...
The shadow you cast is animate and ever-present - sometimes it even acts according to its own will.

You gain the following features.

**Grasping Shadow.** You learn the [Mage Hand](http://dnd2024.wikidot.com/spell:mage-hand) spell and can cast it without spell components. Intelligence, Wisdom or Charisma is your spellcasting ability for this spell (choose when you select this feat).
