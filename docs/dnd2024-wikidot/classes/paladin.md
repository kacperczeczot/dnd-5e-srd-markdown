...
Almost by definition, the life of a Paladin is an adventuring life, for every Paladin lives on the lines of the cosmic struggle against annihilation. Fighters are rare enough among the ranks of the world's armies, but even fewer can claim the calling of a Paladin. When they do receive the call, these blessed folk turn from their former occupations and take up arms and magic.
...
- Gain the Paladin's level 1 features, which are listed in the Paladin Features table. See the multiclassing rules in [multiclassing](http://dnd2024.wikidot.com/class:multiclassing) to determine your available spell slots.
...
| --- | --- | --- |
| 1 | +2 | [Lay On Hands](#Lay-On-Hands), [Spellcasting](#Spellcasting), [Weapon Mastery](#Weapon-Mastery) |
| 2 | +2 | [Fighting Style](#Fighting-style), [Paladin's Smite](#Paladins-Smite) |
| 3 | +2 | [Channel Divinity](#Channel-Divinity), [Paladin Subclass](#Paladin-Subclass) |
| 4 | +2 | [Ability Score Improvement](#Ability-Score-Improvement) |
| 5 | +3 | [Extra Attack](#Extra-Attack), [Faithful Steed](#Faithful-Steed) |
| 6 | +3 | [Aura of Protection](#Aura-of-Protection) |
| 7 | +3 | [Subclass Feature](#Subclass-Feature) |
| 8 | +3 | [Ability Score Improvement](#Ability-Score-Improvement) |
| 9 | +4 | [Abjure Foes](#Abjure-Foes) |
| 10 | +4 | [Aura of Courage](#Aura-of-Courage) |
| 11 | +4 | [Radiant Strikes](#Radiant-Strikes) |
| 12 | +4 | [Ability Score Improvement](#Ability-Score-Improvement) |
| 13 | +5 | - |
| 14 | +5 | [Restoring Touch](#Restoring-Touch) |
| 15 | +5 | [Subclass Feature](#Subclass-Feature) |
| 16 | +5 | [Ability Score Improvement](#Ability-Score-Improvement) |
| 17 | +6 | - |
| 18 | +6 | [Aura Expansion](#Aura-Expansion) |
| 19 | +6 | [Epic Boon](#Epic-Boon) |
| 20 | +6 | [Subclass Feature](#Subclass-Feature) |

###### Paladin Features (Part B)
...
**Prepared Spells of Level 1+.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Paladin spells. [Heroism](http://dnd2024.wikidot.com/spell:heroism) and [Searing Smite](http://dnd2024.wikidot.com/spell:searing-smite) are recommended.
...
**Blessed Warrior.** You learn two Cleric cantrips of your choice (See the Cleric class's section for a list of Cleric spells). [Guidance](http://dnd2024.wikidot.com/spell:guidance) and [Sacred Flame](http://dnd2024.wikidot.com/spell:sacred-flame) are recommended. The chosen cantrips count as Paladin spells for you, and Charisma is your spellcasting ability for them. Whenever you gain a Paladin level, you can replace one of these cantrips with another Cleric cantrip.

### Level 2: Paladin's Smite

You always have the [Divine Smite](http://dnd2024.wikidot.com/spell:divine-smite) spell prepared.
...
| [Oath of the Noble Genies](http://dnd2024.wikidot.com/paladin:oath-of-the-noble-genies) |
| [Oath of Vengeance](http://dnd2024.wikidot.com/paladin:oath-of-vengeance) |

#### Breaking Your Oath

A Paladin tries to hold to the highest standards of conduct, but even the most dedicated are fallible. Sometimes a Paladin transgresses on their oath.
...
You gain the [Ability Score Improvement feat](http://dnd2024.wikidot.com/feat:ability-score-improvement) or another [feat of your choice](http://dnd2024.wikidot.com/feat:all) for which you qualify. You gain this feature again at Paladin levels 8, 12, and 16.
...
You gain an [Epic Boon feat](http://dnd2024.wikidot.com/feat:all) or another feat of your choice for which you qualify. [Boon of Truesight](http://dnd2024.wikidot.com/feat:boon-of-truesight) is recommended.
