...
- Gain the Warlock's level 1 features, which are listed in the Warlock Features table. See the multiclassing rules in [multiclassing](http://dnd2024.wikidot.com/class:multiclassing) to determine your available spell slots.
...
| --- | --- | --- |
| 1 | +2 | [Eldritch Invocations](#Eldritch-Invocations), [Pact Magic](#Pact-Magic) |
| 2 | +2 | [Magical Cunning](#Magical-Cunning) |
| 3 | +2 | [Warlock Subclass](#Warlock-Subclass) |
...
| 9 | +4 | [Contact Patron](#Contact-Patron) |
| 10 | +4 | [Subclass Feature](#Subclass-Feature) |
| 11 | +4 | [Mystic Arcanum (Level 6 Spell)](#Mystic-Arcanum) |
| 12 | +4 | [Ability Score Improvement](#Ability-Score-Improvement) |
| 13 | +5 | [Mystic Arcanum (Level 7 Spell)](#Mystic-Arcanum) |
| 14 | +5 | [Subclass Feature](#Subclass-Feature) |
| 15 | +5 | [Mystic Arcanum (Level 8 Spell)](#Mystic-Arcanum) |
| 16 | +5 | [Ability Score Improvement](#Ability-Score-Improvement) |
| 17 | +6 | [Mystic Arcanum (Level 9 Spell)](#Mystic-Arcanum) |
| 18 | +6 | - |
| 19 | +6 | [Epic Boon](#Epic-Boon) |
| 20 | +6 | [Eldritch Master](#Eldritch-Master) |

###### Warlock Features (Part B)

| Level | Eldritch Invocations | Cantrips | Prepared Spells | Spell Slots | Slot Level |
| --- | --- | --- | --- | --- | --- |
| 1 | 1 | 2 | 2 | 1 | 1 |
| 2 | 3 | 2 | 3 | 2 | 1 |
| 3 | 3 | 2 | 4 | 2 | 2 |
...
**Cantrips.** You know two Warlock cantrips of your choice. [Eldritch Blast](http://dnd2024.wikidot.com/spell:eldritch-blast) and [Prestidigitation](http://dnd2024.wikidot.com/spell:prestidigitation) are recommended. Whenever you gain a Warlock level, you can replace one of your cantrips from this feature with another Warlock cantrip of your choice.
...
For example, when you’re a level 5 Warlock, you have two level 3 spell slots. To cast the level 1 spell [Witch Bolt](http://dnd2024.wikidot.com/spell:witch-bolt), you must spend one of those slots, and you cast it as a level 3 spell.

**Prepared Spells of Level 1+.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Warlock spells. [Charm Person](http://dnd2024.wikidot.com/spell:charm-person) and [Hex](http://dnd2024.wikidot.com/spell:hex) are recommended.
