...
You can use the cauldron as a Spellcasting Focus for your spells, and it functions as a suitable component for the [Scrying](http://dnd2024.wikidot.com/spell:scrying) spell.

**Brew Potion.** When you finish a Long Rest, you can use the cauldron to create a [Potion of Healing (greater)](http://dnd2024.wikidot.com/magic-item:potion-of-healing), which takes 1 minute. The potion lasts for 24 hours, then loses its magic if not consumed.
