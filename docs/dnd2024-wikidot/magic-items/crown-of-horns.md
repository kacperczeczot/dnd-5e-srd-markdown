...
**Source URL:** http://dnd2024.wikidot.com/magic-item:crown-of-horns
...
**Cursed.** The crown is cursed. Attuning to the crown extends the curse to you. Only a [Wish](http://dnd2024.wikidot.com/spell:wish) spell or the will of Myrkul can remove this curse. As long as you remain cursed, the following properties apply to you:
...
**Myrkul’s Hand.** While wearing the crown, you can cast the [Power Word Kill](http://dnd2024.wikidot.com/spell:power-word-kill) spell (save DC 18) from it. A Humanoid killed by this spell rises at the start of your next turn as a Wraith that follows your verbal orders. Once you use the crown to cast this spell, you can’t cast it again from the crown until the next dawn.

**Teleportation.** While wearing the crown, you can cast the [Teleport](http://dnd2024.wikidot.com/spell:teleport) spell. The crown can also cast this spell of its own free will. Once the spell has been cast using the crown, it can’t be cast again until 7 days have passed.
