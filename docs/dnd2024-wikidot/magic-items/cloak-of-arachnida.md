...
**Web.** You can cast [Web](http://dnd2024.wikidot.com/spell:web) (save DC 13). The web created by the spell fills twice its normal area. Once used, this property can’t be used again until the next dawn.
