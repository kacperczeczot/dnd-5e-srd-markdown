...
**Spells.** You can cast one of the following spells (save DC 18), using one of the helm’s gems of the specified type as a component: [Daylight](http://dnd2024.wikidot.com/spell:daylight) (opal), [Fireball](http://dnd2024.wikidot.com/spell:fireball) (fire opal), [Prismatic Spray](http://dnd2024.wikidot.com/spell:prismatic-spray) (diamond), or [Wall of Fire](http://dnd2024.wikidot.com/spell:wall-of-fire) (ruby). The gem is destroyed when the spell is cast and disappears from the helm.
