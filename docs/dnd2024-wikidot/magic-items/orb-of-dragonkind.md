...
**Source URL:** http://dnd2024.wikidot.com/magic-item:orb-of-dragonkind
...
While you are Charmed by the orb, you can’t voluntarily end your Attunement to it, and the orb casts [Suggestion](http://dnd2024.wikidot.com/spell:suggestion) on you at will (save DC 18), urging you to work toward the evil ends it desires. The dragon essence within the orb might want many things: the annihilation of a particular society or organization, freedom from the orb, to spread suffering in the world, to advance the worship of Tiamat, or something else the DM decides.
...
| Spell | Charge Cost |
| --- | --- |
| [Cure Wounds](http://dnd2024.wikidot.com/spell:cure-wounds) (level 9 version) | 4 |
| [Daylight](http://dnd2024.wikidot.com/spell:daylight) | 1 |
| [Death Ward](http://dnd2024.wikidot.com/spell:death-ward) | 2 |
| [Detect Magic](http://dnd2024.wikidot.com/spell:detect-magic) | 0 |
| [Scrying](http://dnd2024.wikidot.com/spell:scrying) (save DC 18) | 3 |
...
**Destroying an Orb.** An *Orb of Dragonkind* has AC 20 and is destroyed if it takes damage from a [+3 Weapon](http://dnd2024.wikidot.com/magic-item:weapon-1-2-or-3) or a [Disintegrate](http://dnd2024.wikidot.com/spell:disintegrate) spell. Nothing else can harm it.
