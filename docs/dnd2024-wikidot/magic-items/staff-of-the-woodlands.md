...
| Spell | Charge Cost |
| --- | --- |
| [Animal Friendship](http://dnd2024.wikidot.com/spell:animal-friendship) | 1 |
| [Awaken](http://dnd2024.wikidot.com/spell:awaken) | 5 |
| [Barkskin](http://dnd2024.wikidot.com/spell:barkskin) | 2 |
| [Locate Animals or Plants](http://dnd2024.wikidot.com/spell:locate-animals-or-plants) | 2 |
| [Pass without Trace](http://dnd2024.wikidot.com/spell:pass-without-trace) | 2 |
| [Speak with Animals](http://dnd2024.wikidot.com/spell:speak-with-animals) | 1 |
| [Speak with Plants](http://dnd2024.wikidot.com/spell:speak-with-plants) | 3 |
| [Wall of Thorns](http://dnd2024.wikidot.com/spell:wall-of-thorns) | 6 |

**Tree Form.** You can take a Magic action to plant one end of the staff in earth in an unoccupied space and expend 1 charge to transform the staff into a healthy tree. The tree is 60 feet tall and has a 5-foot-diameter trunk, and its branches at the top spread out in a 20-foot radius. The tree appears ordinary but radiates a faint aura of Transmutation magic that can be discerned with the [Detect Magic](http://dnd2024.wikidot.com/spell:detect-magic) spell. While touching the tree and using a Magic action, you return the staff to its normal form. Any creature in the tree falls when the tree reverts to a staff.
