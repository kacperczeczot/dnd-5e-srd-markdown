...
| 1d100 | Effect |
| --- | --- |
| 01–20 | You cast a spell originating from the chosen point. Roll 1d10 to determine the spell: on a 1–2, [Darkness](http://dnd2024.wikidot.com/spell:darkness); on a 3–4, [Faerie Fire](http://dnd2024.wikidot.com/spell:faerie-fire); on a 5–6, [Fireball](http://dnd2024.wikidot.com/spell:fireball); on a 7–8, [Slow](http://dnd2024.wikidot.com/spell:slow); on a 9–10, [Stinking Cloud](http://dnd2024.wikidot.com/spell:stinking-cloud). |
...
| 26–30 | You cast [Gust of Wind](http://dnd2024.wikidot.com/spell:gust-of-wind). The Line created by the spell extends from you to the chosen point of origin. |
...
| 46–50 | You cast [Lightning Bolt](http://dnd2024.wikidot.com/spell:lightning-bolt). The Line created by the spell extends from you to the chosen point of origin. |
| 51–55 | The creature closest to the chosen point of origin is enlarged as if you had cast [Enlarge/Reduce](http://dnd2024.wikidot.com/spell:enlarge-reduce) on it. If the target isn’t you and can’t be affected by that spell, you become the target instead. |
...
| 69–72 | Nothing happens at the chosen point of origin. Instead, you shrink as if you had cast [Enlarge/Reduce](http://dnd2024.wikidot.com/spell:enlarge-reduce) on yourself and remain in that state for 1 minute. |
...
| 83–87 | Nothing happens at the chosen point of origin. Instead, you cast [Invisibility](http://dnd2024.wikidot.com/spell:invisibility) on yourself. |
...
| 93–97 | You cast [Polymorph](http://dnd2024.wikidot.com/spell:polymorph), targeting the creature closest to the chosen point of origin. Roll 1d4 to determine the target’s new form. On a 1, the new form is a Black Bear; on a 2, the new form is a Giant Wasp; on a 3–4, the new form is a Frog. |
| 98–00 | The creature closest to the chosen point of origin makes a DC 15 Constitution saving throw. On a failed save, the creature has the Restrained condition and begins to turn to stone. While Restrained in this way, the creature repeats the save at the end of its next turn. On a successful save, the effect ends. On a failed save, the creature has the Petrified condition instead of the Restrained condition. The petrification lasts until the creature is freed by the [Greater Restoration](http://dnd2024.wikidot.com/spell:greater-restoration) spell or similar magic. |
