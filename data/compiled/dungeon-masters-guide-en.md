...
- [Ch. 2: Running the Game](#ch-2-running-the-game)
  ...
  - [The Bonus Doesn't Stack](#the-bonus-doesnt-stack)
  ...
  - [Running Social Interaction](#running-social-interaction)
  - [Running Exploration](#running-exploration)
  - [Running Combat](#running-combat)
  - [Character Advancement](#character-advancement)
- [Ch. 3: DM's Toolbox](#ch-3-dms-toolbox)
  ...
  - [Poison](#poison)
  - [Purchasing Poison](#purchasing-poison)
  - [Harvesting Poison](#harvesting-poison)
  - [Sample Poisons](#sample-poisons)
- [Ch. 7: Treasure](#ch-7-treasure)
  - [Coins](#coins)
  - [Magic Item Categories](#magic-item-categories)
  - [Magic Item Rules](#magic-item-rules)
  - [Magic Item Rarity](#magic-item-rarity)
  - [Activating a Magic Item](#activating-a-magic-item)
  - ["The Next Dawn"](#the-next-dawn)
  - [Cursed Items](#cursed-items)
  - [Magic Item Resilience](#magic-item-resilience)
  - [Crafting Magic Items](#crafting-magic-items)
  - [Time and Cost](#time-and-cost)
  - [Sentient Magic Items](#sentient-magic-items)
  - [Sentient Magic Item Traits](#sentient-magic-item-traits)
  - [Special Purpose](#special-purpose)
  - [Magic Item Special Features](#magic-item-special-features)
  - [Magic Items A–Z](#magic-items-az)
- [Ch. 8: Bastions](#ch-8-bastions)
  - [**Gaining a Bastion**](#gaining-a-bastion)
  - [**Bastion Turns**](#bastion-turns)
  - [**Bastion Map**](#bastion-map)
  - [Mobile Bastions](#mobile-bastions)
  - [Haunted Bastions](#haunted-bastions)
  - [Basic Facilities](#basic-facilities)
  - [**Special Facilities**](#special-facilities)
  - [Special Facility Descriptions](#special-facility-descriptions)
  - [Forgotten Realms: Heroes of Faerun Facilities](#forgotten-realms-heroes-of-faerun-facilities)
  - [Eberron: Forge of the Artificer Facilities](#eberron-forge-of-the-artificer-facilities)
  - [Ravenloft: The Horrors Within Facilities](#ravenloft-the-horrors-within-facilities)
  - [**Bastion Events**](#bastion-events)
  - [**Fall of a Bastion**](#fall-of-a-bastion)
- [Appendix A: Rules Glossary](#appendix-a-rules-glossary)
  - [Glossary Conventions](#glossary-conventions)
  - [Rules Definitions](#rules-definitions)
- [Appendix B: Stat Blocks](#appendix-b-stat-blocks)
  - [Stat Block Overview](#stat-block-overview)
  - [Parts of a Stat Block](#parts-of-a-stat-block)
...
| Poison | Type | Cost | Effect |
| --- | --- | --- | --- |
| Assassin’s Blood | Ingested Poison | 150 GP | A creature subjected to Assassin’s Blood makes a DC 10 Constitution saving throw. On a failed save, the creature takes 6 (1d12) Poison damage and has the Poisoned condition for 24 hours. On a successful save, the creature takes half as much damage only. |
| Burnt Othur Fumes | Inhaled Poison | 500 GP | A creature subjected to Burnt Othur Fumes must succeed on a DC 13 Constitution saving throw or take 10 (3d6) Poison damage, and it must repeat the save at the start of each of its turns. On each successive failed save, the creature takes 3 (1d6) Poison damage. After three successful saves, the poison ends. |
| Carrion Crawler Mucus | Contact Poison | 200 GP | A creature subjected to Carrion Crawler Mucus must succeed on a DC 13 Constitution saving throw or have the Poisoned condition for 1 minute. The creature also has the Paralyzed condition while Poisoned in this way. The creature repeats the save at the end of each of its turns, ending the effect on itself on a success. |
| Essence of Ether | Inhaled Poison | 300 GP | A creature subjected to Essence of Ether must succeed on a DC 15 Constitution saving throw or have the Poisoned condition for 8 hours. The creature also has the Unconscious condition while Poisoned in this way. The creature wakes up if it takes damage or if another creature takes an action to shake it awake. |
| Lolth’s Sting | Injury Poison | 200 GP | A creature subjected to Lolth’s Sting must succeed on a DC 13 Constitution saving throw or have the Poisoned condition for 1 hour. If the creature fails the save by 5 or more, the creature also has the Unconscious condition while Poisoned in this way. The creature wakes up if it takes damage or if another creature takes an action to shake it awake. |
| Malice | Inhaled Poison | 250 GP | A creature subjected to Malice must succeed on a DC 15 Constitution saving throw or have the Poisoned condition for 1 hour. The creature also has the Blinded condition while Poisoned in this way. |
| Midnight Tears | Ingested Poison | 1,500 GP | A creature that ingests Midnight Tears suffers no effect until the stroke of midnight. Any effect that ends the Poisoned condition neutralizes this poison. If the poison hasn’t been neutralized before midnight, the creature makes a DC 17 Constitution saving throw, taking 31 (9d6) Poison damage on a failed save or half as much damage on a successful one. |
| Oil of Taggit | Contact Poison | 400 GP | A creature subjected to Oil of Taggit must succeed on a DC 13 Constitution saving throw or have the Poisoned condition for 24 hours. The creature also has the Unconscious condition while Poisoned in this way. It wakes up if it takes damage. |
| Pale Tincture | Ingested Poison | 250 GP | A creature subjected to Pale Tincture must succeed on a DC 16 Constitution saving throw or take 3 (1d6) Poison damage and have the Poisoned condition. The Poisoned creature repeats the save every 24 hours, taking 3 (1d6) Poison damage on a failed save. The damage the poison deals can’t be healed by any means while the creature remains Poisoned. After seven successful saves against the poison, the creature is no longer Poisoned. |
| Purple Worm Poison | Injury Poison | 2,000 GP | A creature subjected to Purple Worm Poison makes a DC 21 Constitution saving throw, taking 35 (10d6) Poison damage on a failed save or half as much damage on a successful one. |
| Serpent Venom | Injury Poison | 200 GP | A creature subjected to Serpent Venom must succeed on a DC 11 Constitution saving throw, taking 10 (3d6) Poison damage on a failed save or half as much damage on a successful one. |
| Torpor | Ingested Poison | 600 GP | A creature subjected to Torpor poison must succeed on a DC 15 Constitution saving throw or have the Poisoned condition for 4d6 hours. The creature’s Speed is halved while the creature is Poisoned in this way. |
| Truth Serum | Ingested Poison | 150 GP | A creature subjected to Truth Serum must succeed on a DC 11 Constitution saving throw or have the Poisoned condition for 1 hour. The Poisoned creature can’t knowingly communicate a lie. |
| Wyvern Poison | Injury Poison | 1,200 GP | A creature subjected to Wyvern Poison makes a DC 14 Constitution saving throw, taking 24 (7d6) Poison damage on a failed save or half as much damage on a successful one. |
...
**Random Properties.** The axe has the following random properties (see “Artifacts”):
...
This bag resembles a [Bag of Holding](#bag-of-holding) but is a feeding orifice for a gigantic extradimensional creature. Turning the bag inside out closes the orifice.
...
Despite its nihilism, *Blackrazor* feels a strange kinship to [Wave](#wave) and [Whelm](#whelm), two other weapons locked away under White Plume Mountain. It wants the three weapons to be reunited and wielded together in combat, even though it violently disagrees with *Whelm* and finds *Wave* tedious.
...
**Random Properties.** *The Book of Exalted Deeds* has the following random properties (see “Artifacts”):
...
**Random Properties.** The *Book of Vile Darkness* has the following random properties (see “Artifacts”):
...
**Brew Potion.** When you finish a Long Rest, you can use the cauldron to create a [Potion of Healing (greater)](#potion-of-healing), which takes 1 minute. The potion lasts for 24 hours, then loses its magic if not consumed.
...
This small sphere of thick glass weighs 1 pound. If you are within 60 feet of it, you can command it to emanate light equivalent to that of the [Light](#light) or Daylight spell (your choice). Once used, the *Daylight* effect can’t be used again until the next dawn.
...
Found in a small container, this powder resembles [Dust of Disappearance](#dust-of-disappearance), and Identify reveals it to be such. There is enough of it for one use.
...
*Weapon (Warhammer), Very Rare (Requires Attunement by a Dwarf or a Creature Attuned to a [Belt of Dwarvenkind](#belt-of-dwarvenkind))*
...
This onyx statuette of a dog can become a Mastiff for up to 6 hours. The mastiff has an Intelligence of 8 and can speak Common. It also has Blindsight with a range of 60 feet. Once it has been used, it can’t be used again until 7 days have passed.
...
A *Hag Eye* has 3 charges. While wearing or holding this item, you can expend 1 charge to cast [Darkvision](#darkvision) (targeting yourself only) or See Invisibility. The *Hag Eye* regains all expended charges daily at dawn.
...
***Giant’s Bane.*** While you are attuned to the weapon and wearing either a [Belt of Giant Strength](#belt-of-giant-strength) or [Gauntlets of Ogre Power](#gauntlets-of-ogre-power) to which you are also attuned, you gain the following benefits:
...
| 96-99 | The *Moonblade* has the properties of a [Ring of Spell Storing.](#ring-of-spell-storing) |
...
One vial of this oil can coat one Melee weapon or twenty pieces of ammunition, but only ammunition and Melee weapons that are nonmagical and deal Slashing or Piercing damage are affected. Applying the oil takes 1 minute, after which the oil magically seeps into whatever it coats, turning the coated weapon into a [+3 Weapon](#weapon-1-2-or-3) or the coated ammunition into [+3 Ammunition](#ammunition-1-2-or-3).
...
**Random Properties.** An *Orb of Dragonkind* has the following random properties (see “Artifacts”):
...
**Destroying an Orb.** An *Orb of Dragonkind* has AC 20 and is destroyed if it takes damage from a [+3 Weapon](#weapon-1-2-or-3) or a Disintegrate spell. Nothing else can harm it.
...
This concoction looks, smells, and tastes like a [Potion of Healing](#potion-of-healing) or another beneficial potion. However, it is actually poison masked by illusion magic. Identify reveals its true nature.
...
You can cast Dancing Lights or [Light](#light) from the ring.
...
**Drawbacks.** A [Light](#light) spell cast on the robe or a Daylight spell cast within 5 feet of the robe gives you the Blinded condition for 1 minute. At the end of each of your turns, you make a Constitution saving throw (DC 11 for *Light* or DC 15 for *Daylight*), ending the condition on yourself on a success.
...
| 60-68 | 4 [Potions of Healing](#potion-of-healing) |
| 69-75 | Rowboat (12 feet long) |
| 76-83 | [Spell Scroll](#spell-scroll) containing one spell of level 1, 2, or 3 (your choice) |
| 84-90 | 2 Mastiffs |
...
This viscous, milky-white substance can form a permanent adhesive bond between any two objects. It must be stored in a jar or flask that has been coated inside with [Oil of Slipperiness](#oil-of-slipperiness). When found, a container contains 1d6 + 1 ounces.

One ounce of the glue can cover a 1-foot square surface. Applying an ounce of *Sovereign Glue* takes a Utilize action, and the applied glue takes 1 minute to set. Once it has done so, the bond it creates can be broken only by the application of [Universal Solvent](#universal-solvent) or [Oil of Etherealness](#oil-of-etherealness), or with a Wish spell.
...
**Sphere Interactions.** If the sphere comes into contact with a planar portal (such as that created by the Gate spell) or an extradimensional space (such as that within a [Portable Hole](#portable-hole)), the DM determines randomly what happens using the following table.
...
You can break the curse in the usual ways. Alternatively, casting Banishment on the weapon forces the vengeful spirit to leave it. The weapon then becomes a [+1 Weapon](#weapon-1-2-or-3) with no other properties.
...
While holding or wearing this talisman, you have Advantage on any Intelligence (Arcana) check you make to control a [Sphere of Annihilation](#sphere-of-annihilation). In addition, when you start your turn in control of a *Sphere of Annihilation*, you can take a Magic action to move it 10 feet plus a number of additional feet equal to 10 times your Intelligence modifier. This movement doesn’t have to be in a straight line.
...
You can take a Utilize action to pour 1 or more ounces of solvent from the tube onto a surface within reach. Each ounce instantly dissolves up to 1 square foot of adhesive it touches, including [Sovereign Glue](#sovereign-glue).
...
| 1d100 | Effect |
| --- | --- |
| 01–20 | You cast a spell originating from the chosen point. Roll 1d10 to determine the spell: on a 1–2, [Darkness](#darkness); on a 3–4, Faerie Fire; on a 5–6, Fireball; on a 7–8, Slow; on a 9–10, Stinking Cloud. |
...
The Bastion rules in the Dungeon Master’s Guide assume that characters establish their Bastions in a fixed location and that their adventures might take them away from their Bastions at times, perhaps even for long periods. But in Eberron (and perhaps other settings), characters might establish a permanent base of operations that isn’t linked to a fixed location—maybe on a sailing ship, a lightning rail cart, or even an airship. The DM decides whether to allow characters to establish a mobile Bastion, which uses the following alterations to the normal Bastion rules.

A mobile Bastion has two basic requirements: it must be built in a vehicle form, and one of its special facilities must allow for propulsion. (The Lyrandar Helm, Navigator’s Helm, and Orien Helm fulfill that requirement.) If multiple characters combine their Bastions into a single vehicle, each Bastion must include the same kind of special facility that allows for propulsion, and in order for the vehicle to travel, the characters must all issue the Empower order to those facilities at the same time. In this case, however, the combined Bastion can travel more than 8 hours per day; the facility hirelings can operate the vehicle in shifts. Thus, a combined Bastion with at least three Navigator’s Helm facilities can sail for 24 hours a day as the three hirelings trade off navigation in 8-hour shifts.

If characters are traveling with their mobile Bastions, they can also have encounters and face obstacles just as if they were traveling away from their Bastions. When the DM is planning obstacles for such a journey (as described in the Dungeon Master’s Guide), a potential consequence of an encounter or obstacle is the temporary loss of access to one or more of the Bastion’s facilities, including the facility that allows propulsion.

Players and the DM should work together to create a Bastion map that fits within the chosen vehicle. Facilities can be slightly larger or smaller than the rules in the Dungeon Master’s Guide specify, at the DM’s discretion, in order to fit. A mobile Bastion can’t have defensive walls.
...
The rules for Bastions in the Dungeon Master’s Guide allow characters to establish sanctuaries to rest and accrue resources between adventures, but these redoubts aren’t outside the grasp of the Mists.

##### Bastions in the Mists

Bastions in the Domains of Dread work well in campaigns that focus on a single domain or where Darklords aren’t likely to seal their domains’ borders and cut characters off from their Bastions.

Characters can create Bastions in any domain. The domains of Borca, Darkon, Lamordia, Mordent, and the Shadowlands are well suited to hosting Bastions due to their large size or aloof Darklords. Consider having characters inherit one or more existing structures—such as a ruined fortress, secluded tower, or house recently scoured of ghosts. Should characters adopt such a structure, they can refurbish it to their specifications.

How Darklords respond to Bastions is up to you, but don’t create plots that are hostile to Bastions. Darklords might ignore a Bastion, be curious about it, or use it as one more way to bind characters within their domains.
...
| --- | --- | --- | --- |
| 5 | [Arcane Study](#arcane-study) | Ability to use an Arcane Focus or a tool as a Spellcasting Focus | Craft |
| 5 | [Armory](#armory) | None | Trade |
| 5 | [Barrack](#barrack) | None | Recruit |
| 5 | [Garden](#garden) | None | Harvest |
| 5 | [Library](#library) | None | Research |
| 5 | [Sanctuary](#sanctuary) | Ability to use a Holy Symbol or Druidic Focus as a Spellcasting Focus | Craft |
...
| 9 | [Sacristy](#sacristy) | Ability to use a Holy Symbol or Druidic Focus as a Spellcasting Focus | Craft |
| 9 | [Scriptorium](#scriptorium) | None* | Craft |
| 9 | [Stable](#stable-1) | None | Trade |
...
| 13 | [Observatory](#observatory) | Ability to use a Spellcasting Focus | Empower |
| 13 | [Pub](#pub) | None | Research |
| 13 | [Reliquary](#reliquary) | Ability to use a Holy Symbol or Druidic Focus as a Spellcasting Focus | Harvest |
| 17 | [Demiplane](#demiplane) | Ability to use an Arcane Focus or a tool as a Spellcasting Focus | Empower |
| 17 | [Guildhall](#guildhall) | Expertise in a skill | Recruit |
| 17 | [Sanctum](#sanctum) | Ability to use a Holy Symbol or Druidic Focus as a Spellcasting Focus | Empower |
...
| Herb | Garden of rare herbs, some of which have medicinal uses | Herbs that are used to create either ten Healer’s Kits or one [Potion of Healing](#potion-of-healing) |
...
**Harvest: Healing Herbs.** You commission the facility’s hireling to create a [Potion of Healing (greater)](#potion-of-healing) made from healing herbs. The work takes 7 days and costs no money.
...
**Reliquary Charm.** After spending a Long Rest in your Bastion, you gain a magical Charm (see “Supernatural Gifts”) that lasts for 7 days or until you use it. The Charm allows you to cast Greater Restoration once without expending a spell slot or using Material components. You can’t gain this Charm again while you still have it.
...
Inscribed on the floor of this room is a permanent teleportation circle created by the [Teleportation Circle](#teleportation-circle) spell.
...
### Forgotten Realms: Heroes of Faerun Facilities

| Level | Special Facility | Prerequisite | Order |
| --- | --- | --- | --- |
| 5 | [Amethyst Dragon Den](#amethyst-dragon-den) | Membership in the Purple Dragon Knights | Empower |
| 5 | [Harper Hideout](#harper-hideout) | Membership in the Harpers | Empower |
| 5 | [Red Wizard Necropolis](#red-wizard-necropolis) | Membership in the Red Wizards, ability to use a Spellcasting Focus | Recruit |
| 5 | [Zhentarim Travel Station](#zhentarim-travel-station) | Membership in the Zhentarim | Research |
| 9 | [Emerald Enclave Grove](#emerald-enclave-grove) | Membership in the Emerald Enclave | Recruit |
| 9 | [Lords' Alliance Noble Residence](#lords-alliance-noble-residence) | Membership in the Lords’ Alliance | Recruit |
...
**Prerequisite:** Membership in the Purple Dragon Knights
...
This den for an amethyst dragon is an enclosed open chamber with a pool, and one of its entrances is underwater. The facility’s hireling maintains the den and helps any visiting amethyst dragons feel comfortable.
...
**Prerequisite:** Membership in the Cult of the Dragon
...
A Cult of the Dragon Archive contains extensive records on specific topics, including dragons.
...
**Reference Books.** Your Cult of the Dragon Archive contains a collection of draconic lore. You have Advantage on Intelligence (Nature or Religion) checks you make in your Bastion when you take the Study action to recall lore about Dragons, Tiamat, or the Cult of the Dragon.
...
**Prerequisite:** Membership in the Emerald Enclave
...
**Prerequisite:** Membership in the Harpers
...
You have a safe house hidden near your Bastion and connected to it by a tunnel no more than a quarter mile in length. Your hireling maintains the hideout, using a cover identity that doesn’t link them to your Bastion. You can change the location of your Harper Hideout each time you gain a level.

**Hideout Defenses.** Your Harper Hideout is constantly protected by the Alarm spell. At level 9, your Harper Hideout can be connected to your Bastion by a magic doorway instead of a tunnel; anyone passing through the door from the Harper Hideout emerges from a specific door in your Bastion or vice versa, and your Harper Hideout can be located anywhere within 100 miles of your Bastion. At level 13, the facility can be located anywhere in Faerûn. At level 17, the magic doorway works across planes, and the facility can be anywhere in the multiverse.

**Empower: Harper Training.** When you issue the Empower order to this facility, the facility’s hireling extends an invitation to another Harper agent nearby. Roll any die. If the number is odd, no Harper needs your facility and you gain no benefit from having issued the order. If the number rolled is even, a Friendly Harper takes up temporary residence in your hideout.

The Harper stays for 7 days. While at your Bastion, the Harper can share their knowledge. Any character who trains with the Harper here for at least 8 hours on each of those days gains proficiency in one of the following skills of their choice: Deception, Investigation, or Performance. This benefit lasts for 7 days.
...
**Prerequisite:** Membership in the Order of the Gauntlet
...
Your hireling is a Knight whose alignment matches your own. If your Bastion lacks facilities to house this knight, the knight secures accommodations in the inn or settlement closest to the Bastion. This knight isn’t a Bastion Defender, but if your Bastion is attacked, the knight reduces by 1 the number of dice you roll to determine how many Bastion Defenders are lost in the attack.
...
**Prerequisite:** Membership in the Red Wizards, ability to use a Spellcasting Focus
...
Red Wizards defend their strongholds with Undead minions. A Red Wizard Necropolis can accommodate up to eight Bastion Defenders.

**Recruit: Undead Defenders.** Each time you issue the Recruit action to this facility, up to four Undead Bastion Defenders are created and take shelter in the crypts and burial chambers of your Red Wizard Necropolis. You can’t issue the Recruit order to this facility if it’s fully occupied.
...
**Prerequisite:** Membership in the Zhentarim
...
The Zhentarim maintain stations to facilitate safe and swift long-distance travel on journeys (see chapter 2 of the Dungeon Master’s Guide). Your travel station includes temporary stabling facilities for four Large creatures; two Medium creatures occupy the same space as one Large creature there. The facility’s hirelings look after these creatures.

**Long-Distance Travel Speed.** Finishing a Long Rest in your Bastion better prepares you for travel; your group’s maximum travel pace increases by one step (from Slow to Normal or from Normal to Fast).

**Research: Reconnaissance.** When you issue the Research order to this facility, you commission the Zhentarim Travel Station’s hirelings to gather information that facilitates an upcoming journey. This work takes 7 days. For the duration of the journey, you have Advantage on Wisdom (Survival) checks to forage or navigate.

### Eberron: Forge of the Artificer Facilities

| Level | Special Facility | Prerequisite | Order |
| --- | --- | --- | --- |
| 5 | [Dragonmark Outpost](#dragonmark-outpost) | Renown 10+ with any dragonmarked house | Empower |
| 9 | [Kundarak Vault](#kundarak-vault) | Renown 15+ with House Kundarak | Trade |
| 9 | [Navigator's Helm](#navigators-helm) | None | Empower |
| 9 | [Orien Helm](#orien-helm) | Renown 15+ with House Orien | Empower |
| 13 | [Artificer's Forge](#artificers-forge) | Ability to use Artisan’s Tools as a Spellcasting Focus | Craft |
| 13 | [Inquisitive's Agency](#inquisitives-agency) | None | Research |
| 13 | [Lyrandar Helm](#lyrandar-helm) | Renown 25+ with House Lyrandar | Empower |
| 13 | [Manifest Zone](#manifest-zone) | Ability to use a Spellcasting Focus | Empower |
...
**Prerequisite:** Ability to use Artisan’s Tools as a Spellcasting Focus
...
**Crafting Assistants.** If you create a magic item in your Bastion using the rules in the Dungeon Master’s Guide, one or both of this facility’s hirelings can assist you, reducing the time required for the crafting.

**Craft: Magic Item.** When you issue the Craft order to this facility, you commission the facility’s hirelings to craft a Common or an Uncommon magic item chosen by you from the Dungeon Master’s Guide. The facility has the tool required to craft the item, and the hirelings have proficiency with that tool as well as proficiency in the Arcana skill. The two hirelings assist each other, reducing the time required to craft the item. If the item allows its user to cast any spells from it, the hirelings have those spells prepared.
...
**Recruit: Construct.** When you issue the Recruit order to this facility, you commission the facility’s hirelings to craft a Construct from the Forge Constructs table. The construction takes the time and costs you the amount listed in the table.
...
**Prerequisite:** Renown 10+ with any dragonmarked house
...
**Dragonmark Empowerment (Requires Any Dragonmark Feat).** When you finish a Long Rest in your Bastion, you gain one extra spell slot of level 2. You can use this spell slot to cast only a spell you have prepared because of a Dragonmark feat.
...
This facility is an office for an inquisitive agency - either the headquarters of an agency you control or a branch office for a larger agency (such as Information Acquisition or Karr’Aashta’s Investigations, both of which are discussed in Eberron: Forge of the Artificer). Its one hireling is a secretary who maintains an extensive directory of useful contacts and helpful agents.

**Research: Information Gathering.** When you issue the Research order to this facility, you commission the agency’s secretary to gather information from contacts and agents regarding a specific individual you designate, assembling a comprehensive picture of that person’s activities during the previous 7 days and over the course of the next 7 days, within 10 miles of your Bastion. Unless the DM deems that certain information is beyond these agents’ ability to uncover, you learn the following information:
...
**Prerequisite:** Renown 15+ with House Kundarak
...
**Kundarak Access.** Because the vault is an extradimensional space, you (and only you) can access its contents from any Kundarak bank facility in the world. These banks are found in cities across Khorvaire (and also in Stormreach, in Xen’drik).

**Trade: Goods.** When you issue the Trade order to this facility, its hireling spends the next 7 days procuring nonmagical items that have a total value of 2,000 GP or less and stores them in the Kundarak Vault, or the hireling uses those 7 days to sell goods in the Kundarak Vault. You bear the total cost of any purchases, and the maximum value of the items purchased increases to 5,000 GP when you reach level 13.
...
**Prerequisite:** Renown 25+ with House Lyrandar
...
**Prerequisite:** Renown 15+ with House Orien
...
An Orien Helm allows a mobile Bastion built within a Lightning Rail cart to travel. This facility’s hireling is a dragonmarked heir of House Orien.

**Empower: Travel.** When you issue the Empower order to this facility, you instruct its hireling to pilot the Bastion to a destination you specify. The Bastion travels at a rate of 30 miles per hour, 8 hours per day, along an existing route of conductor stones for the duration of the Bastion turn. The Bastion stops early when it reaches the specified destination or if something happens to stop your travel.

When you issue the Empower order to this facility, the DM rolls on the Bastion Events table as if you had issued the Maintain order to your Bastion.

### Ravenloft: The Horrors Within Facilities

| Level | Special Facility | Prerequisite | Order |
| --- | --- | --- | --- |
| 5 | [Rookery](#rookery) | None | Craft |
| 5 | [Séance Parlor](#séance-parlor) | None | Research |
| 9 | [Ancient Altar](#ancient-altar) | None | Empower |
| 9 | [Cabinet of Curiosities](#cabinet-of-curiosities) | None | Trade |
| 9 | [Infirmary](#infirmary) | Proficiency in the Medicine skill | Craft |
| 13 | [Lightning Generator](#lightning-generator) | None | Empower |
...
An Ancient Altar is a solemn chamber where you can make offerings to mysterious forces.

**Empower:** Purge Haunted Facility. You commission your hireling to lead a ritual that takes 7 days, during which time you must remain in the Bastion. At the end of the ritual, you must offer a worthy sacrifice, which can be monetary (1,000 GP) or blood (the fresh corpse of at least one Large creature or four Medium creatures that aren’t Constructs or Undead). If you make a blood sacrifice, roll on the Bastion Hauntings table. Once the ritual is complete, the sacrifice is destroyed. Choose a Haunted special facility in this Bastion or in a Bastion connected to this one; that facility is no longer Haunted.

**Blasphemous Charm.** After spending a Long Rest in your Ancient Altar, you gain a magical Charm that lasts for 7 days or until you use it. You can use the Charm as a Magic action to cast Hunger of Hadar without requiring Material components. You can’t gain this Charm again while you have it.
...
**Trade:** Acquire Curios. When you issue the Trade order to this facility, you supply this facility’s hireling with a certain amount of gold and commission them to purchase strange items from unusual sources. It takes 28 days for the hireling to return to the Bastion with one or more magic items for you. Your investment determines the rarity of these items, and the quantity of magic items depends on the number of Haunted special facilities in your Bastion at the time of the hireling’s return, as shown on the Curio Investment and Curios Collected tables.

| Investment | Item Rarity | Haunted Facilities | Magic Items Acquired | Cursed Item Chance (1d100) |
| --- | --- | --- | --- | --- |
| 150 GP | Common | 0 | 1 | - |
| 600 GP | Uncommon | 1-2 | 1-2 (flip a coin) | 01-10 |
| 6,000 GP | Rare | 3-5 | 1d3 | 01-20 |
| 60,000 GP | Very Rare | 6 | 1d4 | 01-25 |
...
An Infirmary provides emergency healing and continual care to injured or sick Bastion occupants.

**Craft Options.** When you issue the Craft order to this facility, choose one of the following options:

**Craft: Antitoxin.** You commission the facility’s hirelings to craft two vials of Antitoxin. The work takes 7 days and costs no money. You can spend 50 GP during the creation process to enhance one of the vials of Antitoxin, or 100 GP to enhance both. An enhanced Antitoxin ends the Poisoned condition on the creature that drinks it. An enhanced Antitoxin loses this enhancement after 28 days.

**Craft: Enhanced Potion of Healing.** You commission this facility’s hirelings to increase the potency of up to two [Potions of Healing](#potion-of-healing). You must provide the potions to be enhanced, and the process takes 14 days to complete. A Potion of Healing becomes a Potion of Healing (greater). When you reach level 13 you can provide up to two Potions of Healing (greater), each of which becomes a Potion of Healing (superior).

**Triage.** When your Bastion is attacked and you roll a number of dice to determine how many Bastion Defenders are lost, you can reroll a number of those dice equal to the number of hirelings this facility has. You must use the new roll.
...
Your Bastion becomes connected to an unfathomable demiplane filled with vast, empty spaces and strange beings. This special facility doesn’t take up space in your Bastion; instead, the entrance to this facility appears in the closets, crawlspaces, and shadows of your Bastion’s other basic and special facilities. The hireling in charge of this facility protects the Bastion’s inhabitants from stray entities that slip out from the demiplane. This facility always counts as Haunted.

**Dark Bargains.** You can enter this facility and wander within for 7 days, consulting and bargaining with the strange entities there. If you leave the Bastion during this time, you gain no benefit. At the end of the seventh day, you gain a Dark Gift feat of your choice (see chapter 1). You can only have one feat from this benefit at a time; if you use this benefit when you already have a feat from it, the feat you gain at the end of the seven days replaces any feat previously gained from use of this facility.

**Recruit:** Stranger. When you issue the Recruit order to this facility, you instruct the facility’s hireling to conduct a ritual and petition an entity from the demiplane for aid. This ritual takes 7 days and costs 1,000 GP. At the ritual’s end, roll any die. On an odd number, the summoned entity refuses your request and kills the hireling, and this facility can’t be used until your next Bastion turn, at which point the hireling is replaced at no cost to you; on an even number, the summoned entity agrees to your request and takes up residence in your Liminal Space.
...
A number of ravens equal to your character level roost in a Rookery. Whenever a creature enters the facility, the birds uncannily track its movement, an unfathomable intelligence behind their beady eyes.

**Craft: Mist Talisman.** When you issue the Craft order to this facility, you can commission the hireling to send ravens to various contacts in a Domain of Dread you have either visited previously or heard about from a creature that has been within said domain. This work takes 21 days, during which time no other activity can occur within this facility.

At the end of this period, the hireling produces a Mist talisman linked to the chosen Domain of Dread.

**Messenger Ravens.** Whenever you finish a Long Rest in your Bastion, you can send one raven bearing a written message of 25 words or fewer to a creature you have met or a creature described to you by someone who has met it. After receiving this message, the recipient can reply in a like manner, attaching their response to the raven. Regardless of whether or not the recipient responds, the raven returns to the rookery after 7 days have passed.
...
The veil between the world of the living and the dead grows thin in a Séance Parlor.

**Research: Fortune Telling.** When you issue the Research order to this facility, you commission its hireling to read your fortune by casting bones, interpreting tea leaves, performing a tarokka reading, or using some other means. After your fortune is read, you gain Heroic Inspiration. You can’t gain this benefit again until you finish a Long Rest.

**Speak with Dead.** After spending a Long Rest in your Séance Parlor, you can cast Speak with Dead immediately without expending a spell slot or needing Material components. When you cast it in this way, you can target any deceased creature whose name you know, as long as you have a piece of its remains (such as ashes or a bone) or an object that was important to the creature in life (such as a brooch or signature weapon). The target speaks through an implement in the Séance Room such as a crystal ball or spirit board.
...
A Spirit Vault is magically warded to imprison and exorcise malevolent spirits and other supernatural forces. Haunted portraits, cursed relics, and other eerie curios line the shelves of this dark vault. This facility always counts as Haunted.

**Esoteric Knowledge.** After spending a Long Rest in your Spirit Vault, you gain one of the following magical Charms:

**Charm of Exorcism.** You can use the Charm as a Magic action to cast Dispel Evil and Good or Remove Curse without requiring Material components.

**Charm of Malediction.** You can use the Charm as a Magic action to cast Hex (level 3 version) or [Bestow Curse](#bestow-curse) without requiring Material components.

The Charm lasts for 7 days or until you use it. Intelligence, Wisdom, or Charisma is your spellcasting ability for the Charm’s spells (choose each time you gain this Charm).

**Research: Ask the Occult.** When you issue the Research order to this facility, you or its hireling study the various relics and question the imprisoned entities within your Spirit Vault. This work takes 7 days. At the end of this time, roll 1d6. On a 1, the work is psychically taxing; if you did the research, you take 6d6 Psychic damage, and if the hireling did the research, they immediately die, and this facility can’t be used again until your next Bastion turn. Otherwise, you or the hireling gain information as if you had successfully cast the Contact Other Plane spell. The hireling shares any information they learned with you the next time you speak.
...
| 1d100 | Event |
| --- | --- |
| 01-50 | [All is Well](#all-is-well) |
| 51-55 | [Attack](#attack) |
| 56-58 | [Criminal Hireling](#criminal-hireling) |
| 59-63 | [Extraordinary Opportunity](#extraordinary-opportunity) |
| 64-72 | [Friendly Visitors](#friendly-visitors) |
| 73-76 | [Guest](#guest) |
| 77-79 | [Lost Hirelings](#lost-hirelings) |
| 80-83 | [Magical Discovery](#magical-discovery) |
| 84-91 | [Refugees](#refugees) |
| 92-98 | [Request for Aid](#request-for-aid) |
...
| 1d4 | Guest |
| --- | --- |
| 1 | The guest is an individual of great renown who stays for 7 days. At the end of their stay, the guest gives you a letter of recommendation (see “Marks of Prestige”.) |
...
| 91-98 | Roll on Uncommon Magic Items table of your choice (Arcana, Armaments, Implements, or Relics). |
| 99-00 | Roll on a Rare Magic Items table of your choice (Arcana, Armaments, Implements, or Relics). |

##### Haunted Bastions

Haunted Bastions are afflicted by unusual supernatural events. These might be unpredictable annoyances at first, but clever characters might turn hauntings to their advantage.

If you use this system, the first special facility characters create in their Bastion is Haunted. A Haunted special facility has the following rules:

**Irreplaceable.** A Haunted special facility can’t be replaced until it is no longer Haunted.

**Repeating.** While there is at least one Haunted special facility in a Bastion, whenever a character gains a new special facility or replaces a special facility with a different one, roll any die; on an even result, that new facility is Haunted.

When a character issues an order to a Haunted special facility or a Maintain order to their whole Bastion, roll 1d6; on a 1, roll on the Bastion Hauntings table and refer to the “Haunting Descriptions” section to see what happens. A Bastion can experience only one haunting per Bastion turn.

| 1d100 | Haunting |
| --- | --- |
| 01-07 | [Cursed Hireling](#cursed-hireling) |
| 08-15 | [Free-Roaming Spirit](#free-roaming-spirit) |
| 16-22 | [Friendly Ghost](#friendly-ghost) |
| 23-29 | [Hidden Room](#hidden-room) |
| 30-38 | [Lightning Storm](#lightning-storm) |
| 39–47 | [Living Dead](#living-dead) |
| 48-55 | [Mist Wanderers](#mist-wanderers) |
| 56-63 | [Mysterious Priest](#mysterious-priest) |
| 64–71 | [Ill Luck](#ill-luck) |
| 72–79 | [Poltergeist](#poltergeist) |
| 80-86 | Spacial Warp |
| 87-93 | [Spectral Vision](#spectral-vision) |
| 94-100 | [Vistani Visitors](#vistani-visitors) |

##### Haunting Descriptions
...
**Inquisitor (Even).** The priest is a witch hunter. If you have an Ancient Altar, Arcane Study, Cabinet of Curiosities, or Séance Parlor in your Bastion, the priest destroys it and you must replace it with a different special facility. If your Bastion has none of these facilities, the Extraordinary Opportunity Bastion event occurs.
...
**Ruination.** Drawing the Ruin card from the [Deck of Many Things](#deck-of-many-things-1) instantly deprives a character of their Bastion. When such an event occurs, the player can decide what terrible fate befalls the Bastion. The Bastion might be sacked by enemies or destroyed by an earthquake, for example.
